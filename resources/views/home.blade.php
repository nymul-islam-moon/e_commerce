...
<head>
        ...
        @vite(['resources/css/app.css', 'resources/js/app.js','resources/css/plugins/bootstrap.min.css',
                'resources/css/plugins/flaticon.css',
                'resources/css/plugins/font-awesome.css',
                'resources/css/plugins/iconfont.css',
                'resources/css/plugins/ion.rangeSlider.min.css','resources/css/plugins/light-box.css','resources/css/plugins/line-icons.css','resources/css/plugins/slick-theme.css','resources/css/plugins/slick.css','resources/css/plugins/snackbar.min.css','resources/css/plugins/themify.css','resources/css/styles.css'])
        {{-- <link href="/public/css/plugins/animation.css" rel="stylesheet">
        <link href="/public/css/plugins/bootstrap.min.css" rel="stylesheet">
        <link href="/public/css/plugins/flaticon.css" rel="stylesheet">
        <link href="/public/css/plugins/font-awesome.css" rel="stylesheet">
        <link href="/public/css/plugins/iconfont.css" rel="stylesheet">
        <link href="/public/css/plugins/ion.rangeSlider.min.css" rel="stylesheet">
        <link href="/public/css/plugins/light-box.css" rel="stylesheet">
        <link href="/public/css/plugins/line-icons.css" rel="stylesheet">
        <link href="/public/css/plugins/slick-theme.css" rel="stylesheet">
        <link href="/public/css/plugins/slick.css" rel="stylesheet">
        <link href="/public/css/plugins/snackbar.min.css" rel="stylesheet">
        <link href="/public/css/plugins/themify.css" rel="stylesheet">
					...
					<div class="row">
						...
						<div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
							...
							<div class="currency-selector dropdown js-dropdown float-right mr-3">
                                @if (Route::has('login'))
                                    @auth
                                    <a href="{{url('dashboard')}}" class="text-muted medium"><i class="lni lni-user mr-1"></i>Dashboard</a>

                                    @else
                                    <a href="{{ route('login') }}" class="text-muted medium"><i class="lni lni-user mr-1"></i>Sign In</a>

                                    @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="text-muted medium"><i class="lni lni-user mr-1"></i>Register</a>
                                    @endif
                                    @endauth
